...
CAPTURE_PATH = '/home/lightspeed/RAID5-Storage/Lightspeed'
...
class PhaseGUI(tk.Tk):
    ...
    def display_image(self):
        ...
        if self.roi_center is not None:
            cv2.putText(merged_image, f"ROI: ({self.upper_left[0] + self.roi_center[0]}, {self.upper_left[1] + self.roi_center[1]})",
